...
function FriendlyReceptionBar({
  ...
  return (
    <section
      ...
      aria-label="Resumen de documento y captura"
    >
      <div className="grid grid-cols-1 gap-2 px-2.5 py-2 sm:grid-cols-[minmax(0,1fr)_11.5rem] sm:items-center sm:gap-3 md:grid-cols-[minmax(0,1fr)_13rem] lg:grid-cols-[minmax(0,1fr)_14rem]">
        {/* Documento */}
