  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 animate-fade pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-8 md:p-16 rounded-[2rem] border border-slate-200 dark:border-slate-600 shadow-sm text-center flex flex-col items-center justify-center">
        ...
        <h3 className="text-xl font-black text-[#16263F] dark:text-slate-100 uppercase tracking-widest mb-2">
          {subtitle}
        </h3>
        <p className="text-slate-500 dark:text-slate-400 font-medium max-w-md">{description}</p>
      </div>
    </div>
  );
}
