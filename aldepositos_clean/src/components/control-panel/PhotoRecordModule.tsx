  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-0.5 text-xs font-semibold text-slate-500 dark:text-slate-400">
              Documentación visual de RAs para presentar al cliente
            </p>
          </div>
          {selectedTask && (
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#16263F] px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-white shadow-md hover:bg-blue-900"
              >
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-6xl flex-1 flex-col gap-4 overflow-hidden p-4 sm:flex-row sm:p-6">
        {/* Selector de RA */}
        <aside className="flex w-full shrink-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:w-72">
          ...
          {!selectedTask ? (
            <div className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-300">
                Seleccioná un RA para ver o agregar fotos.
              </p>
            </div>
          ) : (
            <>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs sm:grid-cols-4">
                  ...
                  {reportTotals ? (
                    <>
                      ...
                      <InfoChip label="Peso kg" value={String(reportTotals.weight)} />
                    </>
                  ) : null}
                </div>
              </div>
              ...
              {photos.length === 0 ? (
                <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8">
                  ...
                  <button
                    type="button"
                    onClick={() => setCaptureOpen(true)}
                    className="inline-flex items-center gap-2 rounded-xl bg-[#16263F] px-5 py-3 text-xs font-black uppercase tracking-widest text-white"
                  >
                    <Camera className="h-4 w-4" />
                ...
                <div className="grid flex-1 auto-rows-min grid-cols-2 gap-3 overflow-y-auto p-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 sm:gap-4 sm:p-5">
                  {photos.map((photo) => (
                    <article
                      key={photo.id}
                    ...
                    >
                      ...
                      <div className="space-y-1.5 p-2">
                        <select
                          ...
                          className="w-full rounded-md border border-slate-200 bg-slate-50 px-2 py-1 text-[9px] font-bold uppercase tracking-wide dark:border-slate-600 dark:bg-slate-900"
                        >
                        ...
                        <input
                          ...
                          className="w-full rounded-md border border-slate-200 bg-slate-50 px-2 py-1 text-[11px] dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100"
                        />
