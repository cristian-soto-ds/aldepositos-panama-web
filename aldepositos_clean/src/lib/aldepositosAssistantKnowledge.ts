...
- Orden de recolección: borradores de pedido antes del almacén; número de orden; líneas con bultos, unidades, peso, medidas; totales por orden; exportación CSV; botón "Pasar al RA" para volcar medidas a un RA elegible; Alde.IA (asistente de IA) para subir PDF/imagen y extraer líneas. Unidades siempre en piezas (Alde.IA convierte docenas a unidades). Modos por bulto vs totales para unidades y peso.
